...
//        NavigationUI.setupWithNavController(navigationView, navController);
        ...
        clothing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(HomePageActivity.this,"clothing",Toast.LENGTH_SHORT).show();
        ...
        electronics.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(HomePageActivity.this,"electronics",Toast.LENGTH_SHORT).show();
        ...
        books.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(HomePageActivity.this,"books",Toast.LENGTH_SHORT).show();
        ...
        otherItems.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(HomePageActivity.this,"otherItems",Toast.LENGTH_SHORT).show();
